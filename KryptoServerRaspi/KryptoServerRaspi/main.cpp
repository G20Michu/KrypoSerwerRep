...
void GetKrypto(string KryptoName, string Kryptolink)
{
    ...
    vector<string> AktualnaData; //niemzoe byc wspolne
        ...
        while (StatusServer == true)
        {
            ...
            string nazwapliku = "/home/pi/projects/KryptoServerRaspi/Currency/Curr-20TB/"  + KryptoName + ".txt";
...
void confread()
{
    ...
    ifstream Currlink("/home/pi/projects/KryptoServerRaspi/Currency/conf/link.txt");
    ifstream Currname("/home/pi/projects/KryptoServerRaspi/Currency/conf/Currname.txt");
    string linia = "", linia2 = "";
...
public:
    ...
    void remline(int line)
    {
        ...
        Currname.close();
        Currlink.close();
        ofstream Currlinkuppend("/home/pi/projects/KryptoServerRaspi/Currency/conf/link.txt");
        ofstream Currnameuppend("/home/pi/projects/KryptoServerRaspi/Currency/conf/Currname.txt");
    ...
    void Settings()
    {
        ...
        case 1:
        {
            ...
            while (dod == true)
            {
                ...
                ofstream Currlink("/home/pi/projects/KryptoServerRaspi/Currency/conf/link.txt", ios::app);
                ofstream Currname("/home/pi/projects/KryptoServerRaspi/Currency/conf/Currname.txt", ios::app);
                Currlink << link << endl;
